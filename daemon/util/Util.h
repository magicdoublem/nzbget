...
{
public:
	static int DecodeBase64(char* inputBuffer, int inputBufferLength, char* outputBuffer);
	...
	*/
	static bool XmlParseTagValue(const char* xml, const char* tag, char* valueBuf, int32 valueBufSize, const char** tagEnd);
